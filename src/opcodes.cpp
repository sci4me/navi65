...
const u8 OPCODE_ADDRESSING_MODES[256] = {
	...
	/* 1 */ AM_REL, AM_ZPY, AM_IZP, AM_N,   AM_ZP,  AM_ZPX, AM_ZPX, AM_ZP,  AM_IMM, AM_ABY, AM_ACC, AM_N,   AM_AB,  AM_ABX, AM_ABX, AM_ZPR,
	/* 2 */ AM_AB,  AM_ZPX, AM_N,   AM_N,   AM_ZP,  AM_ZP,  AM_ZP,  AM_ZP,  AM_S,   AM_IMM, AM_ACC, AM_N,   AM_AB,  AM_AB,  AM_AB,  AM_ZPR,
	/* 3 */ AM_REL, AM_ZPY, AM_IZP, AM_N,   AM_ZPX, AM_ZPX, AM_ZPX, AM_ZP,  AM_IMM, AM_ABY, AM_ACC, AM_N,   AM_AB,  AM_AB,  AM_AB,  AM_ZPR,
